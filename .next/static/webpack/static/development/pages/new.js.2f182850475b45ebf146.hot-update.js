...
var Form = function Form(_ref) {
  ...
  var handleBody = function handleBody(event) {
    var arrBody = event.target.value.split('   ');
    arrBody.map(function (item) {
      return __jsx("p", {
        __self: _this,
        __source: {
    ...
    console.log(arrBody.map(function (item) {
      return "<p>".concat(item, "</p>");
    }).join(''));
    setError('');
    setPost(_objectSpread({}, post, {
      body: arrBody.map(function (item) {
        return "<p>".concat(item, "</p>");
      }).join('')
    }));
  };
...
//# sourceMappingURL=new.js.2f182850475b45ebf146.hot-update.js.map