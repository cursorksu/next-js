...
})(["box-sizing:border-box;width:100%;height:100%;background:white;padding:20px;box-shadow:0 0 70px rgba(0,0,0,0.1) inset;position:relative;z-index:1;overflow:hidden;& > div{overflow:hidden;text-overflow:ellipsis;font-family:'Raleway',sans-serif;white-space:pre-line;&:before{content:'';width:100%;height:40px;background:linear-gradient( to top,rgba(0,0,0,0.1) 0%,rgba(255,255,255,0.25) 100% );position:absolute;bottom:0;left:0;right:0;z-index:2;}}"]);
...
//# sourceMappingURL=index.js.24d546d8e47a43cc85a8.hot-update.js.map